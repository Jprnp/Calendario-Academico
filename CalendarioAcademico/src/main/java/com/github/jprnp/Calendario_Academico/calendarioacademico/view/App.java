...
public class App {
     ...
     */
    private static void buscarEvento() throws ParseException {
        boolean volta = false;
        do {
            buscaMenu();
    ...
    private static void buscarData() throws ParseException {
        ArrayList<Data> busca = null;
        System.out.println("Digite a data:");
        String dt = readDateFormat();
        busca = CsvBusca.buscaData(todas, dt);
        if (busca.isEmpty()) {
    ...
    private static void bucarNome() throws ParseException {
        ArrayList<Data> busca = null;
        System.out.println("Digite o Nome do Evento:");
        busca = CsvBusca.buscaTitulo(todas, leitor.nextLine());
        if (busca.isEmpty()) {
            System.out.println("Nenhuma evento encontrado.");
        } else {
            busca = CsvUtil.sortCsv(busca);
    ...
    private static void buscaDescri() {
        ArrayList<Data> busca = null;
        System.out.println("Digite a busca:");
        String busc = leitor.nextLine();
        busca = CsvBusca.buscaDescricao(todas, busc);
        for (Data data : CsvBusca.buscaTitulo(todas, busc)) {
    ...
    private static void buscaId() {
        ArrayList<Data> busca = null;
        System.out.println("Digite o id do Evento:");
        busca.add(CsvBusca.buscaId(todas,leitor.nextInt()));
        if (busca.isEmpty()) {
            System.out.println("Nenhuma evento encontrado.");
        } else {
            busca = CsvUtil.sortCsv(busca);
    ...
    private static void escolhaBusca() {
        boolean volta = false;
        do{
            menuEscolha();
            switch(leitor.nextInt()){
